...
Route::group(['prefix' => 'admin/', 'middleware' => ['isAdmin']], function () {
    ...
    Route::get('/plan-crash-time/{id?}', [Admin::class, "crashedtime"]);
    Route::get('/bank-detail', [Admin::class, "bankdetail"]);
    Route::get('/add-recharge', [Admin::class, "recharge"])->name('recharge-r');
    ...
    Route::group(['prefix' => 'api/'], function () {
        ...
        Route::post('/recharge-add', [Adminapi::class, "addrecharge"]);
...
Route::post('/send-otp', [Gamesetting::class, "send_otp"]);
Route::group(['middleware' => ['isUser']], function () {
    ...
    Route::get('/level-detail', [Pages::class,'level_detail'])->name('level_detail');

    Route::get('/deposit_withdrawals', [Userdetail::class, "deposit_withdrawal"]);
    Route::get('/withdrawals-list', [Userdetail::class, "withdrawal_list_new"]);
    ...
    Route::post('/insert/joinuser', [Adminapi::class, "joinuser"])->name('joinuser');
