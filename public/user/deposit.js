...
function openapps()
{
    var currentAmount = $("#select_amount").text();
    var currentupi = $("#owner_mobile_no").text();
    window.open("upi://pay?pa="+currentupi+"&pn=aviator&cu=INR&tn=aviator&am="+currentAmount);
}
