...
class Userdetail extends Controller
{
    ...
    public function withdrawal_list_new()
    {
        $deposit = Transaction::where('userid', user('id'))->where('category','withdraw')->orderBy('id', 'desc')->get();
        return view('withdrawals-list', compact("deposit"));
    }
