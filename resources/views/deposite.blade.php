                ...
                <div class="col-md-6">
                    ...
                    <div class="pay-options">
                        <div class="payment-cols">
                            <div class="grid-view">
                                <div style="display:none;" class="grid-list" onclick="paymentGatewayDetails('6')">
                    ...
                    <div class="pay-static-form text-white fw-bold">
                        ...
                        <div class="white-box mt-3 text-center">
                            <img src="{{ url(bankdetail()) }}" class="barcode-img" id="barcode"/>
                        ...
                        <div class="white-box mt-3">
                         ...
                         style="display: none"
                         onclick="openapps()">
                            <h5 class="text-muted f-14 fw-bold">Open Upi Apps</h5>
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="dopsite-vlue fw-bold f-20">
                                    <div> <img src="images/app-logo/upi_apps.png" height="100" width="400" /></div>
                                </div>
                                <button class="btn btn-transparent p-0">
                                    <span class="material-symbols-outlined bold-icon">
                                        edit
                                        ...
                                        <div class="login-controls">
                                            <label for="mobile_no">
                                                <input type="text" class="form-control text-indent-0" id="mobile_no"
                                                    name="mobile_no" value="{{ user('mobile') }} " readonly>
                                            </label>
                                        </div>
                                    </div>
