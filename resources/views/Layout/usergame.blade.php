                ...
                <div class="modal-body pt-0">
                    ...
                    <form class="login-form" method="post" id="forgotPasswordForm">
                        ...
                        <button  class="btn green-btn md-btn custm-btn-2 mx-auto mt-3 mb-3 w-100"
                             type="button" onclick="otpcheck()">PROCEED</button>
                                ...
                                <form class="register-form row" action="/auth/register" method="post"
                                    ...
                                    {{--  <div class="col-12">
                                        <div class="input-group flex-nowrap mb-3 promocode align-items-center">
                                            ...
                                            <input type="number" class="form-control ps-0" id="otp"
                                    ...
                                    <div class="col-12 " style="display: none;">
                                        ...
                                        <div class="input-group flex-nowrap mb-3 promocode align-items-center">
                                            ...
                                            <input type="email" class="form-control ps-0" id="reg_email"
                                                placeholder="Email" name="email" value="phone_number@gmail.com">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group flex-nowrap mb-3 promocode align-items-center">
                                    ...
                                    <div class="col-12">
                                        ...
                                        {{--  <label for="promo_code" id="otpsms" class="text-primary"></label>  --}}
                                    </div>
        ...
        function sendotpforget(){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#otp_error").html('OTP Send Successfully');
                }
            });
        }
