...
<div class="container">
    <div class="invitation-block">
        ...
        <div class="code-lg">
            <p>Toatal Player: <span>{{ $totalusers }}</span></p>
        </div>
    </div>
    <div class="white-block">


        <div class="level-block level1" onclick="window.location.href='{{ route('level_detail') }}?type=1'">
        ...
        <div class="level-block level2" onclick="window.location.href='{{ route('level_detail') }}?type=2'">
        ...
        <div class="level-block level3" onclick="window.location.href='{{ route('level_detail') }}?type=3'">
