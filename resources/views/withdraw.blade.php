                            ...
                            <div class="grid-view">
                                ...
                                <div class="grid-list">
                                    <button class="btn payment-btn" data-bs-toggle="modal" data-bs-target="#withdraw-modal"
                                        ...
                                        <div class="PaymentCard_limit">Net Banking<br/>Min : 200</div>
                                    </button>
                                </div>
                                ...
                                <div class="grid-list">
                                    <button class="btn payment-btn" data-bs-toggle="modal" data-bs-target="#withdraw-modal"
                                        ...
                                        <div class="PaymentCard_limit">UPI<br/>Min : 200</div>
                                    </button>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body pt-1">
                    <form class="login-form text-center" action="/insert/withdrawal" method="post" >
                        @csrf
                        ...
                        <div id="upi_id_div">
                            ...
                            <div class="login-controls">
                                <label for="upi_id">
                                    <input type="text" class="form-control " id="7777"
                                        name="upi_id3" value="{{isset($bank->upi_id) ? $bank->upi_id : ''}}" >
                                </label>
                            </div>
...
@endsection
@section('js')
<script    src="user/withdraw.js"></script>
@isset($_GET['msg'])
@if ($_GET['msg'] == 'Success')
    <script>
...
@if ($_GET['msg'] == 'error1')
    <script>
        toastr.error("minimum one 100 recharge required!");
    </script>
@endif
@if ($_GET['msg'] == 'error3')
    <script>
        toastr.error("you have a already withdrawal request!");
    </script>
@endif
@if ($_GET['msg'] == 'error2')
    <script>
        toastr.error("you can withdraw only this time 07:00 - 08:30");
    </script>
@endif
@endisset
@endsection
