<footer>
    <div class="footer-top">
        <a href="dashboard" class="footer-logo"><img style="width: 75px" src="images/logo.png" class="logo1"></a>
    </div>
    <div class="footer-top">
        <div class="footer-column footer-column_center social-icons">
            <div class="darkblue-bg">
                ...
                <div class="footer-icon_monocolor ms-4" onclick="window.location.href='https://t.me/Aviatorproearnandgrow'">
                ...
                <div class="footer-icon_monocolor ms-4" onclick="window.location.href='https://instagram.com/aviatpro?igshid=OGQ5ZDc2ODk2ZA%3D%3D&utm_source=qr'">
